						...
						<tbody>
							...
							<c:forEach var="vo" items="${lists}" varStatus="vs">
								<tr>
									...
									<td>
									<a href="downloadCertificate.jsp?cert_num=${vo.cert_num}" class="btn btn-primary btn-sm">
										다운로드
									</a>
									</td>
								</tr>
							...
							<tr>
								...
								<td><c:if test="${not empty sessionScope.loginVo}">
										<input type="text" name="requestId"
											value="${sessionScope.loginVo.emp_id}" readonly>
								...
								<td><input name="requestDate" id="requestDate" readonly></td>
							</tr>
							<tr>
								...
								<td><c:if test="${not empty sessionScope.loginVo}">
										<input type="text" name="name"
											value="${sessionScope.loginVo.name}" readonly>
									</c:if> <c:if test="${empty sessionScope.loginVo}">
							...
							<tr>
								...
								<td><c:if test="${not empty sessionScope.loginVo}">
										<input type="text" name="department"
											value="${sessionScope.loginVo.dept_name}" readonly>
									</c:if> <c:if test="${empty sessionScope.loginVo}">
								...
								<td><c:if test="${not empty sessionScope.loginVo}">
										<input type="text" name="position"
											value="${sessionScope.loginVo.position}" readonly>
									</c:if> <c:if test="${empty sessionScope.loginVo}">
